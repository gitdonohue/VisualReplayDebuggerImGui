...
int main(int, char**)
{
    ...
    VisualReplayDebugger::ReplayWindowsLayout visualReplayDebuggerLayout(replayContext);
    ...
    GLFWwindow* window = glfwCreateWindow(3000, 1600, "Visual Replay Debugger", nullptr, nullptr);
    if (window == nullptr)
        return 1;
...
#endif
    {
        ...
        // 
        visualReplayDebuggerLayout.Draw();
